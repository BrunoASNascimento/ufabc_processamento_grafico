...
int main(int argc, char **argv)
{
	...
	loadObj("/Users/brunonascimento/developer/github.com/ufabc_processamento_grafico/lab_04/data/elepham.obj");
	// troque por: elepham.obj mba1.obj porsche.obj radar.obj teddy.obj
	// e adequar o modo de visualização
	glutMainLoop();
	return 0;
}
